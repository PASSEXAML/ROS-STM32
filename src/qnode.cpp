...
#include <sstream>
#include "../include/ros_gui_n/qnode.hpp"
...
bool QNode::init() {
	ros::init(init_argc,init_argv,"ros_gui_n");
	if ( ! ros::master::check() ) {
		return false;
	}
  ...
  odom_sub=n.subscribe("odom_raw",1000,&QNode::odom_callback,this);
